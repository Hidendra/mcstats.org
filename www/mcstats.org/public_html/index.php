...
<div class="hero-unit">
    ...
    <p><a href="/learn-more/" class="btn btn-success"><i class="icon-white icon-heart"></i> Learn More</a> :: <a class="btn btn-primary" href="/plugin-list/"><i class="icon-white icon-th-list"></i> Plugin List</a></p>
</div>
